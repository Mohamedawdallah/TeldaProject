...
class MoviesPopularViewModelTest {
    ...
    @Test
    fun `getMoviesPopular() return success`() = runTest {
    ...
    @Test
    fun `getMoviesSearch() with correct search text request then return success`() = runTest {
        //Arrange
    ...
    @Test
    fun `getMoviesSearch() with wrong search text request then return Failed`() = runTest {
        //Arrange
        val searchText = ""
